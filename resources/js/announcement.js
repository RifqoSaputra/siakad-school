document.addEventListener('DOMContentLoaded', () => {
    ...
    filters.forEach(f => {
        const btn = f.querySelector('.filter__btn, .ann-filter__btn');
        const options = f.querySelectorAll('.filter__option, .ann-filter__option');
    ...
    const guruDetailFields = {
        ...
        nip: document.getElementById('guru-detail-nip'),
    ...
    reasonChips.forEach(chip => chip.addEventListener('click', () => {
    ...
    function openGuruDetail(row) {
        ...
        guruDetailFields.nip.textContent = get('guruNip') || '-';
    ...
    btnSaveStatus?.addEventListener('click', () => {
        ...
        // TODO: hook to backend for status update with currentGuru, selectedReason, and noteInput.value
