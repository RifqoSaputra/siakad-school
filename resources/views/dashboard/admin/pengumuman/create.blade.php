...
@section('content')
    <div class="container-fluid">
        <h4 class="mb-3">Buat Pengumuman Baru</h4>
                ...
                <form action="{{ route('admin.pengumuman.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="target_role" class="form-select" required>
                            ...
                            <option value="ortu" {{ old('target_role') === 'ortu' ? 'selected' : '' }}>Orang Tua</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="isi_pengumuman" rows="5" class="form-control" placeholder="Tulis isi pengumuman...">{{ old('isi_pengumuman') }}</textarea>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary" type="submit">
                            <i class="bi bi-send"></i> Simpan & Kirim Notifikasi
                        </button>
                    </div>
                </form>
            </div>
